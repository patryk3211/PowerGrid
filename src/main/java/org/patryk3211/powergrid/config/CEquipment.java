...
public class CEquipment extends ConfigBase {
    ...
    public final ConfigInt drillEnergyPerUse = i(100, 1, "portableDrillEnergyPerUse", Comments.drillEnergyPerUse);
    ...
    private static class Comments {
        ...
        public static final String drillEnergyPerUse = "Energy used by Portable Drill per block mined";
