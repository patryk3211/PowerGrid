...
public class ItemApplicationRecipes<P extends ProcessingRecipeParams, R extends ProcessingRecipe<?, P>, B extends ProcessingRecipeBuilder<P, R, B>> extends ProcessingRecipeGen<P,R,B> {
    ...
    public ItemApplicationRecipes(PackOutput generator, CompletableFuture<HolderLookup.Provider> registries) {
