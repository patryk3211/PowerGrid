...
public class ServoRenderer extends KineticBlockEntityRenderer<ServoBlockEntity> {
    ...
    protected SuperByteBuffer getRotatedModel(ServoBlockEntity be, BlockState state) {
        return CachedBuffers.partialFacing(AllPartialModels.SHAFT_HALF, state, state.getValue(ServoBlock.FACING));
    }
}
